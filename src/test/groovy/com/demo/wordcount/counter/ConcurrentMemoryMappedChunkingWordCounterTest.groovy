...
class ConcurrentMemoryMappedChunkingWordCounterTest extends Specification {
    ...
    def "should be able to retrieve the top frequent words (using suggested buffer settings) when #scenario"() {
        ...
        "file is greater than buffer size and 126-length word" | Paths.get(FILES_DIR).resolve("file_126-length.txt") | 5               | 5            | ['abcdefghijklmnopqrstuvwxyzabcdefghijklmnopqrstuvwxyzabcdefghijklmnopqrstuvwxyzabcdefghijklmnopqrstuvabcdefghijklmnopqrstuvwxyz': 26600, 'apple': 33, 'banana': 32, 'cherry': 31, 'date': 23]
